...
const Countdown = (props) => {
  ...
  useEffect(() => {
    ...
    interval.current = setInterval(() => {
      const date = moment();
      const d = decimalNumber(newDate.diff(date, "days"));
      const h = decimalNumber(newDate.diff(date, "hours") % 60);
      const m = decimalNumber(newDate.diff(date, "minutes") % 60);
      const s = decimalNumber(newDate.diff(date, "seconds") % 60);
      ...
      if (canvasCountdown.countdown < 0.1) {
