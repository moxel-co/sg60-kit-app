...
const LayeredMaterial = ({
    ...
    const material = useMemo(() => {
        ...
        mat.onBeforeCompile = (shader) => {
            ...
            shader.uniforms.graphicsTexture = { value: graphics_texture };
            ...
            shader.fragmentShader = shader.fragmentShader.replace(
                ...
                #include <map_fragment>
                    ...
                    vec2 graphicsUv = vMapUv * 3.3;
                    graphicsUv.x = (graphicsUv.x - 0.75) * 1.5 + 0.5;
                    graphicsUv.x += -0.15;
                    graphicsUv.y += -1.0;
                    vec4 graphicsTexColor = texture2D(graphicsTexture, graphicsUv);
                    vec2 iconUv = vMapUv * 34.0;
                    iconUv.x = (iconUv.x - 2.8) * 1.2 + 0.5;
                    iconUv.x += -12.0;
                    iconUv.y += -12.0;
